# Instalador OCA para Odoo 18

## Objetivo

Este modulo proporciona un instalador visual para clonar, exponer e instalar addons OCA desde repositorios de GitHub en una instancia Odoo 18.
...
Este modulo esta configurado para Odoo 18.
