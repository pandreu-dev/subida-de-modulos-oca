{
    "name": "Instalador OCA para Odoo 18 Community",
    ...
    "license": "LGPL-3",
    "description": """
Instalador visual de repositorios OCA para Odoo 18 Community.
...
- Preparado para un entorno Plesk/Debian con servicio odoo18 y rutas bajo /opt/odoo18.
