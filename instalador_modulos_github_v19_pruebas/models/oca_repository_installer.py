...
PARAM_BRANCH = "instalador_modulos_github_v19_pruebas.oca_git_branch"
PARAM_CLONE_ROOT = "instalador_modulos_github_v19_pruebas.oca_clone_root"
PARAM_SHARED_ROOT = "instalador_modulos_github_v19_pruebas.oca_shared_addons_path"
PARAM_PATH_STRATEGY = "instalador_modulos_github_v19_pruebas.oca_path_strategy"
PARAM_PERSIST_CONFIG = "instalador_modulos_github_v19_pruebas.oca_persist_addons_path_to_config"
PARAM_ODOO_CONFIG_PATH = "instalador_modulos_github_v19_pruebas.oca_odoo_config_path"
PARAM_AUTO_PYTHON = "instalador_modulos_github_v19_pruebas.oca_auto_install_python_deps"
PARAM_AUTO_BINARY = "instalador_modulos_github_v19_pruebas.oca_auto_install_binary_deps"
PARAM_PYTHON_COMMAND = "instalador_modulos_github_v19_pruebas.oca_python_install_command"
PARAM_BINARY_COMMAND = "instalador_modulos_github_v19_pruebas.oca_binary_install_command"
...
class OcaRepositoryInstaller(models.Model):
    ...
    def _default_branch(self):
        return self._get_param(PARAM_BRANCH, "19.0")
    ...
    def _get_settings(self):
        return {
            "branch": self._get_param(PARAM_BRANCH, "19.0"),
            "clone_root": self._get_param(PARAM_CLONE_ROOT, "/opt/odoo19_pruebas/addons/oca/repositories"),
            "shared_root": self._get_param(PARAM_SHARED_ROOT, "/opt/odoo19_pruebas/addons/oca"),
            ...
            "odoo_config_path": self._get_param(PARAM_ODOO_CONFIG_PATH, "/etc/odoo19_pruebas.conf"),
    ...
    def _runtime_addons_paths(self):
        ...
        raw_paths = raw_value.split(",") if isinstance(raw_value, str) else raw_value
        return [
    ...
    def _ensure_runtime_addons_path(self, addons_path):
        ...
        if normalized_path not in current_paths:
            ...
            tools.config["addons_path"] = current_paths
    ...
    def _validate_source_addon(self, addon_line):
        ...
        if not snapshot["disk_path_exists"]:
            ...
            resolution_lines.append(
                _("Activa installable = True en el manifest o usa otra rama compatible con Odoo 19.")
            )
